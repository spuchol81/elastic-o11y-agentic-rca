...
Instruqt variant of ../setup_agent.py — identical tools/skills/agent
definitions, pointed at the self-hosted Kibana running inside the Instruqt
...
Run after ingest.py and setup_ml_jobs.py — requires KB_URL/KB_USER/KB_PASS env vars
