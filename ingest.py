...
Usage:
    export ES_CLOUD_ID=my-deployment:dXMtZWFzdC0xLmF3cy5mb3VuZC5pbyQ...
...
# Generate fresh NDJSON files (timestamps = last night) before ingesting
...
def build_client() -> Elasticsearch:
    if not ES_CLOUD_ID:
        print("ERROR: ES_CLOUD_ID is not set")
        sys.exit(1)
    if not ES_API_KEY:
        print("ERROR: ES_API_KEY is not set")
        sys.exit(1)
